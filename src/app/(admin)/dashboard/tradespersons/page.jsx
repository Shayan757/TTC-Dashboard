...
// import UserDetails from "../tradespersons/[id]/page";
              ...
              <tbody>
                {currentItems.map((user) => (
                  <tr key={user.id} className="border-t">
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-2 py-1 rounded-full text-sm ${user.SubscriptionType.type === "Gold"
                    ...
                    <td className="px-6 py-4 text-right">
                      ...
                      {/* <Link href={`tradespersons/${user.id}`}>
                ...
                <MoveRight
                   ...
                   /> 
                      ...
                      {/* <Link
  href={{
    pathname: `tradespersons/${user.id}`,
    query: { selectedUser: JSON.stringify(user) }, // Pass user data via query
  }}
>
  <MoveRight />
</Link> */}
...
//                   <td className="px-6 py-4 flex items-center">
//                     {user.profileUrl ? (
//                       <img src={user.profileUrl} alt="avatar" className="w-10 h-10 rounded-full mr-3" />
//                     ) : (
//                       <Image
//                         src={user.profileUrl || userImage}
//                         width={40}

...
import userIcon from '../../app/assets/userImage.png'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full py-4 px-3 text-xs border border-gray-50 rounded-lg focus:ring-yellow-500 focus:border-yellow-500"
